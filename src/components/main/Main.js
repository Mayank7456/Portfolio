                ...
                <div className={styles.quickDetails} >
                    ...
                    <div className={styles.aboutMe} >
                        <div className={styles.intro} >
                            ...
                            <h2>Mayank Singh</h2>
                            <p>As a budding Full Stack Developer, I bring a fresh perspective and a passion for crafting innovative solutions. While I may be a fresher, my project experiences showcase my dedication and potential in delivering impactful results.</p>
                        </div>
